...
void StereoPannerAudioProcessorEditor::resized()
{
    ...
    sliderPanPosition->setBounds (24, 32, 240, 128);
...
<JUCER_COMPONENT documentType="Component" className="StereoPannerAudioProcessorEditor"
  ...
  <SLIDER name="new slider" id="7cf6d9a8ea20b3da" memberName="sliderPanPosition"
          virtualName="" explicitFocusOrder="0" pos="24 32 240 128" min="-1"
